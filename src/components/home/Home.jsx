                ...
                <div className={styles.con}>
                    ...
                    <div className={styles.contant}>
                        ...
                        <div className={styles.buttons}>
                            <a href="https://drive.google.com/file/d/1FTGMBRCoN3EJbKtDQLshIKNaotochFHX/view?usp=sharing" rel='noreferrer' target='_blank'><button className={styles.button1}>Download CV</button></a>
