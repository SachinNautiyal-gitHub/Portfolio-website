                ...
                <div className={styles.con}>
                    ...
                    <div className={styles.contant}>
                        ...
                        <div className={styles.buttons}>
                            <a href="https://drive.google.com/file/d/1ayFTs9_0d30J6dWSXv6VQ9f9K96Ib9Qw/view?usp=sharing" rel='noreferrer' target='_blank'><button className={styles.button1}>Download CV</button></a>
